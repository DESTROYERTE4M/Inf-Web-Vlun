...
Coded : Mr.S4dB0y
------------------------------
$white Scanning Site : " . $fgreen . $ipsl . $ip . $blue . "\n\n";
echo $red . " [0]  Basic Recon \n [1]  WHOIS Lookup \n [2]  Geo-IP Lookup \n [3]  Grab Banners \n [4]  DNS Lookup \n [5]  Subnet Calculator \n [6]  NMAP Port Scan \n [7]  Subdomain Scanner \n [8]  Reverse IP Lookup & CMS Detection \n [9]  SQLi Scanner $red \n [10] Bloggers View  \n [11] WordPress Scan \n [12] Crawler \n [13] MX Lookup \n [14] Scan For Everything  \n$red [Q]  Quit! \n\n" . $cln;
askscan:
    userinput("$white local@host~#");
        ...
        elseif ($scan == "8")
          {
            ...
            if (count($array) > 0)
              {
                userinput("Do You Want  To Detect CMS Of The Sites? [Y/N]");
            ...
            if (strpos($srccd, "wp-content") !== false)
              {
                ...
                if ($wp_version != "")
                  ...
                  {
                    $reallink = $ipsl . $ip;
                    echo $red . "Failed \n\n[!] could not determine the WordPress version of the target!";
                    echo "\n\n";
                    echo $bold . $yellow . "[*] Scanning Complete. Press Enter To Continue OR CTRL + C To Stop\n\n";
                    trim(fgets(STDIN, 1024));
                    goto scanlist;
